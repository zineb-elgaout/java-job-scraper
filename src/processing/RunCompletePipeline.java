...
public class RunCompletePipeline {
    public static void main(String[] args) {
        System.out.println("🚀 PIPELINE COMPLET DE PRÉPARATION POUR WEKA");
        System.out.println("════════════════════════════════════════════════════════");
        ...
        try {
            ...
            System.out.println("ÉTAPE 2/4 : 🔍 EXTRACTION DES CARACTÉRISTIQUES");
            System.out.println("─".repeat(50));
            FeatureExtractorBasic.main(args);
            
            System.out.println("\n" + "═".repeat(70) + "\n");
            
            // Étape 3: Équilibrage des catégories
            ...
            System.out.println("─".repeat(50));
            WekaExporter.main(args);
            
            long endTime = System.currentTimeMillis();
            long duration = (endTime - startTime) / 1000;
            
            System.out.println("\n" + "═".repeat(70));
            System.out.println("✅ PIPELINE TERMINÉ EN " + duration + " SECONDES");
    ...
    private static void displayFinalSummary() {
        ...
        System.out.println("│ 04_dataset_complet.csv      - Dataset complet       │");
        System.out.println("│ 05_dataset_simplifié.csv    - Pour débuter          │");
        System.out.println("│ 06_weka_ready.arff          - Format ARFF           │");
        System.out.println("│ 07_guide_weka.txt           - Guide d'utilisation   │");
        System.out.println("└─────────────────────────────────────────────────────┘");
        
        System.out.println("\n🎮 POUR COMMENCER AVEC WEKA :");
        System.out.println("  1. Ouvrir Weka Explorer");
        System.out.println("  2. Cliquer sur 'Open file'");
        System.out.println("  3. Choisir '06_weka_ready.arff'");
        System.out.println("  4. Suivre les instructions dans '07_guide_weka.txt'");
        ...
        System.out.println("\n💡 CONSEIL : Commencez avec '05_dataset_simplifié.csv'");
